...
-- 1. POSTCODE
\copy postcode (postcode, latitude, longitude, suburbs) FROM '/csvdata/postcode_location_db.csv' WITH (FORMAT csv, HEADER true, NULL '')
 
 
-- 2. OPEN_SPACE
\copy open_space (open_space_id, name, latitude, longitude, category) FROM '/csvdata/open_space_location_db.csv' WITH (FORMAT csv, HEADER true, NULL '')
