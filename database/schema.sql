...
DROP TABLE IF EXISTS ACTIVITY_VARIETY_TAG CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS ACTIVITY_LOCATION_CATEGORY CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS ACTIVITY CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS OPEN_SPACE CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS VARIETY_TAG CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS WEATHER_DEPENDENCY CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS MISSION_TYPE CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS SUPERVISION_LEVEL CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS EQUIPMENT_REQUIRED_TAG CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS INDOOR_OUTDOOR_TAG CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS LOCATION_CATEGORY CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS POSTCODE CASCADE CONSTRAINTS PURGE;
