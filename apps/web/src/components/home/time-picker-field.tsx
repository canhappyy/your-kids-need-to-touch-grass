      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <Select
            ...
            value={hours}
          >
            <SelectTrigger className="h-[52px] w-full rounded-xl border-zinc-200 bg-[#F0B6A31F] px-4 text-base font-semibold focus-visible:border-[#E4633C] focus-visible:ring-[#E4633C]/20">
              <SelectValue />
            </SelectTrigger>
