...
type MissionInstructionsDialogProps = Pick<Recommendation, "title" | "instructionText">
    ...
    <DialogContent className="max-h-[85svh] grid-rows-[auto_minmax(0,1fr)] gap-5 rounded-2xl bg-[#FDF6EA] p-6 sm:max-w-lg">
      ...
      <div className="overflow-y-auto overscroll-contain break-words">
        {steps.length ? (
          ...
          <p className="text-sm text-zinc-600">Instructions unavailable for this activity.</p>
        )}
      </div>
    </DialogContent>
  )
